...
plugins=(coffeescript git rake heroku python node scala history-substring-search)
...
alias hrtf="source ~/dev/env-hrtf_aud/bin/activate; cd ~/dev/hrtf_auditioning"
alias gd="git diff"
alias gs="git status"
alias gl="git log"
alias gc="git commit"
